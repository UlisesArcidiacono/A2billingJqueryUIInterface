...
$(document).ready(function() {
    $('[color="#FFFFFF"]').attr("color", "#999999");
	$('[bgcolor="#FFFFFF"]').attr("bgcolor", "");
	$('[bgcolor="#F2F2EE"]').attr("bgcolor", "");
	$("tr").attr("onmouseout","#121417");
	$("tr").attr("onmouseover","");
	$('tr').filter(function(){
		return $(this).attr('bgcolor') == '#FCFBFB';
	}).attr("bgcolor","");
    $('.nav-header').css("color", "#33b5e5");
	$('[background="./templates/temp4/images/background_cells.gif"]').attr("background", "");	
});