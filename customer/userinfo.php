...
<tr>
    <td align="center" colspan="2" >
        ...
        <a align="center" href="A2B_entity_card.php?atmenu=password&form_action=ask-edit&stitle=Personal+Information">
            <?php echo gettext("EDIT PERSONAL INFORMATION");?>
        </a>
        <?php } ?>
    </td>
</tr>
    ...
    <tr>
        <td align="center" colspan="2" class="tableBodyRight" >
            <form action="checkout_payment.php" method="post" target="_blank">
                <input type="submit" class="btn btn-warning" value="<?php echo gettext("BUY NOW");?>">
                <br>
            </form>
        </td>
    </tr>
